...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/bootsnav.css">

        <!-- xsslider slider css -->


        <!--<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/xsslider.css">-->
        ...
        <!--<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/colors/maron.css">-->
    ...
    <body data-spy="scroll" data-target=".navbar-collapse">
                ...
                <div class="container"> 
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#brand">
                            ...
                            <!--<img src="${pageContext.request.contextPath}/resources/images/footer-logo.png" class="logo logo-scrolled" alt="">-->
                        </a>
                        ...
                        <div class="main_business">
                                    ...
                                    <div class="business_items text-center">
                                        <div class="business_item">
                                            <div class="business_img">
                                                <img src="${pageContext.request.contextPath}/resources/images/about-img1.jpg" alt="" />
                                            </div>
                                        </div>

                                        <div class="business_item">
                                            <div class="business_img">
                                                <img src="${pageContext.request.contextPath}/resources/images/about-img2.jpg" alt="" />
                                            </div>
                                        </div>

                                        <div class="business_item">
                                            <div class="business_img">
                                                <img src="${pageContext.request.contextPath}/resources/images/about-img3.jpg" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="business_item sm-m-top-50">
                                    <h2 class="text-uppercase">이달의 혜택</h2>
                                    <ul>
                                        <li><i class="fa fa-arrow-circle-right"></i> 안전주차로~ 봄 나들이 이벤트</li>
                                        <li><i class="fa  fa-arrow-circle-right"></i> 3월 현대자동차 구매상담 이벤트</li>
                                        <li><i class="fa  fa-arrow-circle-right"></i> 3월 신차 구매 혜택</li>
                                    </ul>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="${pageContext.request.contextPath}/resources/images/work-img1.jpg" alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="${pageContext.request.contextPath}/resources/images/work-img1.jpg" class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="${pageContext.request.contextPath}/resources/images/work-img2.jpg" alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="${pageContext.request.contextPath}/resources/images/work-img2.jpg" class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                                    <div class="port_caption m-top-20">
                                                        <h5>Your Work Title</h5>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="${pageContext.request.contextPath}/resources/images/work-img3.jpg" alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="${pageContext.request.contextPath}/resources/images/work-img3.jpg" class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                                    <div class="port_caption m-top-20">
                                                        <h5>Your Work Title</h5>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="${pageContext.request.contextPath}/resources/images/work-img4.jpg" alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="${pageContext.request.contextPath}/resources/images/work-img4.jpg" class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                                    <div class="port_caption m-top-20">
                                                        <h5>Your Work Title</h5>
                        ...
                        <div class="main_test fix">
                            ...
                            <div class="col-md-6">
                                <div class="test_item fix">
                                    <div class="item_img">
                                        <img class="img-circle" src="${pageContext.request.contextPath}/resources/images/test-img1.jpg" alt="" />
                            ...
                            <div class="col-md-6">
                                <div class="test_item fix sm-m-top-30">
                                    <div class="item_img">
                                        <img class="img-circle" src="${pageContext.request.contextPath}/resources/images/test-img2.jpg" alt="" />
                                        <i class="fa fa-quote-left"></i>
                                    </div>
                        ...
                        <div class="main_brand text-center">
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="${pageContext.request.contextPath}/resources/images/cbrand-img1.png" alt="" />
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="${pageContext.request.contextPath}/resources/images/cbrand-img2.png" alt="" />
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="${pageContext.request.contextPath}/resources/images/cbrand-img3.png" alt="" />
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="${pageContext.request.contextPath}/resources/images/cbrand-img4.png" alt="" />
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="${pageContext.request.contextPath}/resources/images/cbrand-img5.png" alt="" />
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="${pageContext.request.contextPath}/resources/images/cbrand-img6.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="widget_item widget_latest sm-m-top-50">
                                    ...
                                    <div class="widget_latst_item m-top-30">
                                        <div class="item_icon"><img src="${pageContext.request.contextPath}/resources/images/ltst-img-1.jpg" alt="" /></div>
                                    ...
                                    <div class="widget_latst_item m-top-30">
                                        <div class="item_icon"><img src="${pageContext.request.contextPath}/resources/images/ltst-img-2.jpg" alt="" /></div>
                                        <div class="widget_latst_item_text">
                                            <p>Lorem ipsum dolor sit amet, consectetur</p>
                                            <a href="">21<sup>th</sup> July 2016</a>
                                        </div>
                                    ...
                                    <div class="widget_latst_item m-top-30">
                                        <div class="item_icon"><img src="${pageContext.request.contextPath}/resources/images/ltst-img-3.jpg" alt="" /></div>
                                        <div class="widget_latst_item_text">
                                            <p>Lorem ipsum dolor sit amet, consectetur</p>
                                            <a href="">21<sup>th</sup> July 2016</a>
                                        </div>
        ...
        <script src="${pageContext.request.contextPath}/resources/css/slick/slick.js"></script>
        <script src="${pageContext.request.contextPath}/resources/css/slick/slick.min.js"></script>
